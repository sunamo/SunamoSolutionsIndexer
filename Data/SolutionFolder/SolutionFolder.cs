...
namespace AllProjectsSearch
{
    ...
    public class SolutionFolder : SolutionFolderSerialize, IProjectType
    {
        ...
        public static void GetCsprojs(SolutionFolder sf, GetCsprojsArgs a = null)
        {
            ...
            if ((sf.projectsGetCsprojs == null) || a.forceReload)
            {
                ...
                sf.projectsGetCsprojs = new sunamo.Collections.DebugCollection<string>(csprojs);
        ...
        public SolutionFolder(SolutionFolderSerialize t)
        {
            ...
            if (t.GetType() == SolutionFolder.type)
            {
        ...
        public void UpdateModules(PpkOnDrive toSelling)
        {
            if (toSelling != null)
            {
                this.modulesSelling = SolutionsIndexerHelper.ModulesInSolution(this.projectsInSolution, this.fullPathFolder, true, toSelling);
                this.modulesNotSelling = SolutionsIndexerHelper.ModulesInSolution(this.projectsInSolution, this.fullPathFolder, false, toSelling);
            }
        }
        ...
        private string FindExistingFolderWithRightArchitecture(string net7, string exeNameWithExt)
        {
            ...
            if (FS.ExistsFile(maybe))
            {
                return FS.GetDirectoryName(maybe);
            }
        ...
        {
            var f = Path.Combine(this.fullPathFolder, VisualStudioTempFse.gitFolderName);
